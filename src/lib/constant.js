export const IconsDetails = [
  {
    ...
    iconsSvg: (
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
        className="h-6 w-6 fill-white transition hover:fill-zinc dark:fill-textZinc group-hover:fill-textZinc cursor-pointer"
      >
  ...
  },
  {
    ...
    iconsSvg: (
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
        className="h-6 w-6 fill-zinc transition hover:fill-zinc dark:fill-textZinc group-hover:fill-textZinc cursor-pointer"
      >
